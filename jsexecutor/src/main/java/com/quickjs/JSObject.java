...
public class JSObject extends JSValue {
    ...
    public int getInteger(String key) {
        return (int) get(TYPE.INTEGER, key);
    }

    public boolean getBoolean(String key) {
        return (boolean) get(TYPE.BOOLEAN, key);
    }

    public double getDouble(String key) {
        return (double) get(TYPE.DOUBLE, key);
    }
    ...
    public JSArray getArray(String key) {
        return (JSArray) get(TYPE.JS_ARRAY, key);
    }

    public JSObject getObject(String key) {
        return (JSObject) get(TYPE.JS_OBJECT, key);
    }
