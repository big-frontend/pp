...
public class JSArray extends JSObject {
    ...
    public int getInteger(int index) {
        Object result = get(TYPE.INTEGER, index);
    ...
    public boolean getBoolean(int index) {
        Object result = get(TYPE.BOOLEAN, index);
    ...
    public double getDouble(int index) {
        Object result = get(TYPE.DOUBLE, index);
    ...
    public String getString(int index) {
        Object result = get(TYPE.STRING, index);
    ...
    public JSObject getObject(int index) {
        Object result = get(TYPE.JS_OBJECT, index);
    ...
    public JSArray getArray(int index) {
        Object result = get(TYPE.JS_ARRAY, index);
